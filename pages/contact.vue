        ...
        <section class="contact-v2 relative z-1">
            ...
            <div class="w-[calc(100%_-_2.5rem)] lg:w-[calc(100%_-_4rem)] mx-auto max-w-7xl">
                ...
                <dl class="details-list details-list--rows grid grid-cols-12 details-list--cols@md">
                    <div @click="handleMaps('option1')" 
                        class="cursor-pointer hover:bg-contrast-low hover:bg-opacity-20 details-list__item py-5 lg:py-8 lg:px-8 lg:text-center col-span-12 lg:col-span-6"
                        :class="option1 ? 'bg-contrast-low bg-opacity-10' : ''"
                        >
                        <dt class="text-primary font-bold mb-1.5 lg:mb-2">ბერბუკის ქუჩა 10</dt>
