import { y as withLeadingSlash, j as joinURL, x as withoutTrailingSlash, z as withBase, t as hash } from '../../nitro/node-server.mjs';
import { d as useRuntimeConfig, f as useRequestEvent } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-85232504.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-10e41dc8.mjs.map
