import { E as withLeadingSlash, j as joinURL, D as withoutTrailingSlash, F as withBase, o as hash } from '../../nitro/node-server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-a4025949.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-b5bc364d.mjs.map
