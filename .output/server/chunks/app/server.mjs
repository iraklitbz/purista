import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, defineComponent, h, onUnmounted, toRef, isRef, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, Fragment, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, Text, isShallow, isReactive, toRaw, withCtx } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as defu, o as sanitizeStatusCode, q as createHooks, r as getRequestHeaders } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-us-8df615b6.mjs').then((m) => m.default || m)
  },
  {
    name: "about-us___en",
    path: "/en/about-us",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/faqs-e872abd8.mjs').then((m) => m.default || m)
  },
  {
    name: "faqs___en",
    path: "/en/faqs",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0489486b.mjs').then((m) => m.default || m)
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-6b931995.mjs').then((m) => m.default || m)
  },
  {
...
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-f8963256.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-149131e3.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-65397101.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-bd31d8e2.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-4e69972c.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-824b9480.mjs').then((r) => r.default));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-656394fd.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./_nuxt/ProsePre-1680f006.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-c05e796e.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-2c7c8bb2.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-1b4bc157.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-ae9c7cb8.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-df0fbe97.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-226df555.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-8aa94a2d.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-b6b4612f.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-c6835a6c.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-caa2b141.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-d16e9a39.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-fe54a744.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-d33b8778.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-a3309860.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./_nuxt/ProseScript-1498bd1f.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-4266f147.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-dbabb38a.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-90b21eb5.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-7f1b2700.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-6c7802ed.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-e3c6580e.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-cb49ff2d.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-4c643788.mjs').then((r) => r.default));
...
const plugin_H8JWoUb1Oz = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a;
      ...
      nuxtApp._gqlState.value[name] = {
        ...
        instance: new GraphQLClient(host, {
          ...
          requestMiddleware: async (req) => {
            ...
            const reqOpts = defu(((_b = (_a2 = nuxtApp._gqlState.value) == null ? void 0 : _a2[name]) == null ? void 0 : _b.options) || {}, { headers: {} });
            if (!token.value) {
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18n = await vueI18nConfigLoader(() => import(
    './_nuxt/i18n.options-461efc21.mjs'
...
const layouts = {
  default: () => import('./_nuxt/default-27158005.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-537e9660.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-b4248679.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-d6984abc.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRoute as a, useState as b, useNuxtApp as c, useRuntimeConfig as d, useHead as e, useRequestEvent as f, asyncDataDefaults as g, createError as h, useRouter as i, navigateTo as j, useLocalePath as k, getComposer as l, isFunction$1 as m, nuxtLinkDefaults as n, isObject$1 as o, parse as p, server as s, useI18n as u };
