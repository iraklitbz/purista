import{_ as h}from"./nuxt-link.46b1d731.js";import{u as i,i as v,j as b,h as y,o as r,c,a as t,F as w,r as k,b as u,w as _,f as e,d as $,t as p}from"./entry.924b29e5.js";import{u as B}from"./composables.687cf796.js";import{g as C}from"./index.5ada8b90.js";const N={class:"max-w-4xl mx-auto mt-10 parrafBox px-5 md:px-0"},P={class:"grid grid-cols-2 md:grid-cols-4 gap-4"},q={class:"rounded-xl shadow-md overflow-hidden"},L=["src"],V={class:"p-1 lg:p-1 text-center"},j={class:"text-lg lg:text-2xl"},A={class:"my-1 lg:my-1.5"},E={class:"prod-card-v2__price text-primary font-bold text-xl"},F={__name:"ProductsComponent",async setup(I){let o,l;i();const n=B(),{locale:a}=i(),m=C`
