import{_ as v}from"./nuxt-link.46b1d731.js";import{u as y,i as w,h as $,c as a,a as t,t as r,F as _,r as p,f as e,j as k,o as l,b as m,w as x,d as B}from"./entry.924b29e5.js";import{u as N}from"./composables.687cf796.js";import{g as q}from"./index.5ada8b90.js";const C={class:"max-w-4xl mx-auto py-20 parrafBox px-5 md:px-0"},L={class:"parrafBox mb-10"},P={class:"text-2xl font-bold"},V={class:"mt-6 text-base text-contrast-medium"},j={class:"mb-2"},A={class:"grid grid-cols-2 md:grid-cols-3 gap-4"},E={class:"rounded-xl shadow-md overflow-hidden"},F=["src"],I={class:"p-1 lg:p-1 text-center"},D={class:"text-lg lg:text-xl mt-2"},G={class:"my-1 lg:my-1.5"},Q={class:"prod-card-v2__price text-xl text-primary font-bold"},M={__name:"index",async setup(S){let o,d;const{locale:c}=y(),n=N(),h=q`
