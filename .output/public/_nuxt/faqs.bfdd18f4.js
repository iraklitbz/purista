import{_ as f}from"./nuxt-icon.vue.7042b4b3.js";import{h as u,u as h,i as v,c as o,a as t,F as q,r as w,f as r,j as k,o as l,n as _,t as d,b as C,k as A}from"./entry.7a543543.js";import{g as N}from"./index.4a1114bc.js";const $={class:"max-w-3xl mx-auto py-10 px-5 md:px-0"},B={class:"w-[calc(100%_-_2.5rem)] lg:w-[calc(100%_-_4rem)] mx-auto max-w-3xl"},F={class:"my-10"},V=["onClick"],j={class:"text-lg lg:text-xl text-left"},E={key:0,class:"pt-1.5 lg:pt-2 px-5 lg:px-8 pb-5 lg:pb-8"},I={class:"text-component leading-snug text-space-y-md"},L={class:"text-gray-600 text-lg"},J={__name:"faqs",async setup(z){let s,c;const a=u(null),{locale:m}=h(),p=N`
